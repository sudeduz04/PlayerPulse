...
class LeagueFixtureSeeder extends Seeder
{
    ...
    private function stadium(string $teamName): string
    {
        return match ($teamName) {
            ...
            'Eyüpspor' => 'Atatürk Olimpiyat Stadyumu',
            ...
            'Çaykur Rizespor' => 'Çaykur Didi Stadyumu',
            'Kocaelispor' => 'Kocaeli Stadyumu',
            'Fatih Karagümrük' => 'Atatürk Olimpiyat Stadyumu',
            'Gençlerbirliği' => 'Eryaman Stadyumu',
